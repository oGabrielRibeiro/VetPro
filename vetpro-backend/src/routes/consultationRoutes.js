...
router.post(
  '/heuristic-parse',
  authMiddleware,
  consultationController.heuristicParse,
);
router.post('/chat-assist', authMiddleware, consultationController.chatAssist);
router.post(
  '/refine-field',
  authMiddleware,
  consultationController.refineField,
);
router.get(
  '/:id/chat-history',
  authMiddleware,
  consultationController.getChatHistory,
);
router.post(
  '/:id/chat-history',
  authMiddleware,
  consultationController.appendChatHistory,
);
...
router.post(
  '/:id/create-return',
  authMiddleware,
  consultationController.createReturn,
);
router.post(
  '/:id/files',
  authMiddleware,
